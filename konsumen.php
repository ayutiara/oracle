          ...
          <div class="row">
			...
			<form class="form-horizontal" action="add.php" method="post">
			 <div class="form-row">
				<div class="form-group col-md-6">
				  <label for="">ID</label>
				  <input type="text" class="form-control" name="id" placeholder="Id konsumen">
				</div>
				<div class="form-group col-md-6">
			...
			<div class="form-row">
				<div class="form-group col-md-6">
				  ...
				  <input type="text" class="form-control" name="jk" placeholder="jk konsumen">
				</div>
				<div class="form-group col-md-6">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
						include 'koneksi.php';
						$stid = oci_parse($conn, 'SELECT * from decal');
						oci_execute($stid);
                        ...
                        <tr>
                          ...
                          <td class="td-actions">
						  <a href="konsumen_update.php?id=<?= $d['ID'] ?>">
